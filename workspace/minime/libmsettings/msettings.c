/*
 * Minime libmsettings.
 * Shared-memory settings bridge (same contract as upstream) plus the
 * traits-driven MINIME_* hardware HAL used by the UI, keymon and this
 * library itself. Upstream keeps hardware access inline in msettings.c
 * too; minime resolves the device paths from the traits file instead of
 * hardcoding them.
 */
#include <fcntl.h>
...
///////////////////////////////
// traits-driven hardware HAL (MINIME_*)
